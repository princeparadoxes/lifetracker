<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="checkstyle">
        <html>
            ...
            <body>
                ...
                <!-- Summary part -->
                <xsl:apply-templates select="." code="summary" />
                <hr size="1" width="100%" align="left" />

                <!-- Package List part -->
                <xsl:apply-templates select="." code="filelist" />
                <hr size="1" width="100%" align="left" />
    ...
    <xsl:template match="checkstyle" code="filelist">
        <h3>Files</h3>
    ...
    <xsl:template match="checkstyle" code="summary">
        <h3>Summary</h3>
