...
public class StatisticTypeAdapter extends RecyclerView.Adapter<StatisticTypeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        int iconTint = ContextCompat.getColor(holder.itemView.getContext(), android.R.color.darker_gray);
        StatisticType statisticType = data.get(position);
        Glide.with(holder.itemView.getContext())
                .load(statisticType.getIcon())
                .listener(new TintOnLoad(holder.imageView, iconTint))
                .into(holder.imageView);
        holder.textView.setText(statisticType.getName());
    }
