...
public class LiquidPaint {
    ...
    public static LiquidPaint SOLID() {
        return new LiquidPaint(Color.BLACK, ParticleFlag.elasticParticle, ParticleGroupFlag.rigidParticleGroup);
    }

    public static LiquidPaint ELASTIC() {
        return ELASTIC(Color.GREEN);
    }
    ...
    public static LiquidPaint LIQUID(int color) {
        return new LiquidPaint(color, ParticleFlag.waterParticle, ParticleGroupFlag.particleGroupCanBeEmpty);
    }

    public static LiquidPaint ELASTIC(int color) {
        return new LiquidPaint(color, ParticleFlag.elasticParticle, ParticleGroupFlag.rigidParticleGroup);
    }
